...
func GetPropertyRecommendations(userPref models.Preferences, properties []models.Property) (string, error) {
	...
	prompt.WriteString("The are in square in square feet of the property suggested should be equal to or higher than the area in the user preferences and the address of the property suggested should match the types of areas provided in the locations from the user preferences.\n")
